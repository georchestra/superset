...
SQLALCHEMY_DATABASE_URI='postgresql://{os.getenv("DATABASE_USER"}:{os.getenv("DATABASE_PASSWORD"}@{os.getenv("DATABASE_HOST"}/{os.getenv("DATABASE_DB"}?options=-c%20search_path=superset'
